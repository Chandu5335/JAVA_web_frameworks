...
<h3 align=center , style = "color : green">Welcome&nbsp;<c:out value="${euname}"></c:out></h3>
...
<tr><th>Date of Birth:</th>&nbsp;<td>${emp.dateofbirth}</td></tr></br>

<tr><th>Department:</th>&nbsp;<td>${emp.department}</td></tr>
<tr><th>Designation:</th>&nbsp;<td>${emp.designation}</td></tr>
<tr><th>Salary:</th>&nbsp;<td>${emp.salary}</td></tr></br>
