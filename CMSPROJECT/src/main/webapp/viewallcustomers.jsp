...
<h3 align=center><u>Here are your Customers</u></h3>
...
<a href='<c:url value='deletecustomer?id=${cust.id}'></c:url>'>Delete</a>&nbsp;&nbsp;
<a href='<c:url value='viewcustomerbyid?id=${cust.id}'></c:url>'>View</a>&nbsp;&nbsp;
